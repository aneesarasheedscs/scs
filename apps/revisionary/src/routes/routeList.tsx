...
const SignForm = lazy(
  () => import('@revisionary/pages/Syllabus_Management/Revisionary_ui/SyllabusStatus/Comp/SignForm')
);
...
const StudentSyllabus = lazy(
  () =>
    import('@revisionary/pages/Syllabus_Management/Revisionary_ui/SyllabusStatus/Comp/StudentSyllabus/StudentSyllabus')
);
...
const LoginForm = lazy(
  () => import('@revisionary/pages/Syllabus_Management/Revisionary_ui/SyllabusStatus/Comp/LoginForm')
);
