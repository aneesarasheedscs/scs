...
import '../Syllabus_Management/Style.css';
...
import { AntCard } from '../Syllabus_Management/Component/AntCard';
  ...
  return (
    ...
    <Card className="tabcard">
        ...
        <div className="card-container">
          ...
          <AntCard 
          data={apiResponse?.data?.apiData} isLoading={isLoading} isError={isError}  style={{width:'100%'}} >
        ...
        {/* <UpdateSyllabusAuthority open={open} form={form} handleClose={handleClose} selectedRecordId={selectedRecordId} /> */}
    </AntCard>
