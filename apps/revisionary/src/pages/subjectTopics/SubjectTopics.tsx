...
// import './SyllabusManagement/Queries/types';
// import { useGetTopics1 } from "./queries";
...
const SubjectTopics1: React.FC = () => {
  ...
  // const selectedSubjectData = data?.data?.apiData.find(
  //   (subject:DataType) => subject.subject === selectedSubject
  // );

  const selectedSubjectData = data.find((subject) => subject.subject === selectedSubject);
  return (
    <div className="maincard" style={{ width: '135%', height: 'auto', marginLeft: '14%' }}>
      <Card
        style={{
          width: '100%',
          height: 'auto',
