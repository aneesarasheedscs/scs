...
export default function Dashboard() {
  const cardArray = [
    { id: 1, title: 'Biology', progress: 50 },
    { id: 2, title: 'Computer', progress: 75 },
    { id: 3, title: 'Math', progress: 75 },
    { id: 4, title: 'Physics', progress: 75 },
    { id: 5, title: 'Chemistry', progress: 75 },
    { id: 6, title: 'English', progress: 75 },
    { id: 7, title: 'Business_Studies', progress: 75 },
  ];
  ...
  return (
    <div className="syllabus-status">
      ...
      <div className="flip" style={{ width: '70%', marginLeft: '7%', maxHeight: '15rem' }}>
