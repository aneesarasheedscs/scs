...
const Tab3 = () => {
  return (
    <div style={{width:"100%",borderRadius: '6px', marginLeft:'390px', marginTop:'40px', boxShadow: 'rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px'}}>
