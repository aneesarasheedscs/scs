  ...
  return (
    <div className="form1" style={{marginTop:'2%'}}>
      ...
      <Form
        ...
        style={{ marginTop: "-336px", marginLeft: "950px", width: "100%" ,boxShadow:
        'rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px',}}
      >
        <h2 style={{ fontWeight: "bold", fontSize: "30px", textAlign:'center' }}>
          Student Profile Form
        </h2><Divider orientation='center' style={{marginTop:'10px'}}></Divider>
    ...
    />
      ...
      <Link to="/syllabus1"><AntButton label={'Next Page'} style={{position:'absolute', top:'4%', left:'2%'}}></AntButton></Link>
