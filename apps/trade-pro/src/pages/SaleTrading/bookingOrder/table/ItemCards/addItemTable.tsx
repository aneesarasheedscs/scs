...
<Row justify={'space-between'} style={{ border: '1px solid ', padding: 4 }}>
        <Col xxl={12} lg={14} style={{ display: 'flex', justifyContent: 'space-between' }}>
          <Col>
            <h5>
          ...
          <Col>
            <h5>
              Item: <span style={{ background: 'lightgrey', borderRadius: 10, padding: 3 }}>2</span>
            </h5>
          </Col>
          <Col>
            <h5>
      ...
      <Row justify={'space-between'} style={{ border: '1px solid ', padding: 4 }}>
        <Col xxl={14} lg={14} style={{ display: 'flex', justifyContent: 'space-between' }}>
          <Col>
            <p style={{ color: '', textDecoration: 'line-through' }}>1121 STEAM RICE HADARI ASWEI 35 KG</p>
            <Col xxl={6} lg={6} style={{  display: 'flex', justifyContent: 'space-between' }}>
              <p style={{ color: '', textDecoration: 'line-through' }}>Price: </p>
              <Col>
                <span style={{ color: 'red', textDecoration: 'line-through' }}>14</span>
              </Col>
            </Col>
          </Col>
        </Col>
    ...
    <Row gutter={[10,16]}> */}
        ...
        <Col xxl={14} lg={14} style={{ display: 'flex', justifyContent: 'space-between' }}>
          <Row justify={'space-between'}>
            <Col>
              <h5>
                Qty:{' '}
                <span style={{ borderLeft: '1px solid grey', borderRight: '1px solid grey', padding: 3, color: 'red' }}>
                  <MinusOutlined />
                </span>
              </h5>
            </Col>
      ...
      <Row justify={'space-between'} style={{ border: '1px solid ', padding: 4 }}>
        <Col xxl={14} lg={14} style={{ display: 'flex', justifyContent: 'space-between' }}>
          <Col>
            <p style={{ color: '' }}>1121 STEAM RICE HADARI ASWEI 35 KG</p>
            <Col xxl={6} lg={6} style={{display: 'flex', justifyContent: 'space-between' }}>
