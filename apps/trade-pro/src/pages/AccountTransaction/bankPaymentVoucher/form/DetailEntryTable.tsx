    ...
    setTableData((prevData: any[]) => {
      ...
      if (rowIndex !== -1) {
        updatedData[rowIndex] = {
          ...updatedData[rowIndex],
          AccountIdDebit: record.AccountId,
              ...
              <>
                <div style={{ maxHeight: '26vh' }}>
                  ...
                  >
                    ...
                    >
                      <Col xl={3} xxl={3} lg={3} md={3} sm={4} style={{ border: '' }}>
                  ...
                  {map(tableData, (item, index) => (
                    <>
                      ...
                      >
                        <Col lg={3} xl={3} xxl={3} sm={4} xs={4} md={3} style={{ border: ' ', paddingLeft: 5 }}>
                          <p className="dataIndexes"> {item.PaymentType} </p>
                        </Col>
                        <Col lg={6} xl={4} xxl={4} md={6} sm={7} xs={7} style={{ border: ' ', paddingLeft: 5 }}>
                          <p className="dataIndexes"> {item.AccountTitle} </p>
                        </Col>

                        <Col lg={2} xl={2} xxl={2} md={2} sm={3} xs={3} style={{ border: ' ', paddingLeft: 5 }}>
                          <p className="dataIndexes">{item.JobLotDescription} </p>
                        </Col>

                        <Col lg={4} xl={2} xxl={2} md={4} sm={5} xs={5} style={{ border: ' ', paddingRight: 5 }}>
                        ...
                        <Col lg={9} xl={6} xxl={4} md={9} sm={6} xs={6} style={{ border: ' ', paddingLeft: 5 }}>
                          <p className="dataIndexes">{item.PayeeTitle} </p>
                        </Col>
                        <Col lg={10} xl={6} xxl={4} md={10} sm={8} xs={8} style={{ border: ' ', paddingLeft: 5 }}>
