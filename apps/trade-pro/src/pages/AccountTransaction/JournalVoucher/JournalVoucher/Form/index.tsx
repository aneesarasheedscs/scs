...
function JournalVoucherForm({
  ...
  const { mutate: addJournalVoucher, isSuccess, data: saveData } = useAddJournalVoucher();
  const { mutate: updateJournalVoucher, data: updateData } = useUpdateJournalVoucher(selectedRecordId);
