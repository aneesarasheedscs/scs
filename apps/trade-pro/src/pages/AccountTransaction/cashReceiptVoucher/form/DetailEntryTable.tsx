...
function DetailEntryTable({ form, t, setIsEditMode, setEdit, setRefAccountId, setrowIndex }: TDetailEntryProps) {
  ...
  const handleDeleteRow = (record: TCashReceiptDetailEntry, rowIndex: number) => {
    console.log(record);
  ...
  const handleEditRow = (record: TCashReceiptDetailEntry, index: number) => {
    console.log(record);
  ...
  return (
    <>
      <Row gutter={[16, 0]} style={{ maxHeight: '26vh', marginTop: 10 }}>
        <Col span={24}>
          <Card
