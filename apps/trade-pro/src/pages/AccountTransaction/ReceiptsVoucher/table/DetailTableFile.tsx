...
import { TReceiptsDetailEntry } from '../form/types';
...
const Tablefile: React.FC<{ selectedRecordId?: number | null; voucherData: any }> = ({
  ...
  const [mainDataSource, setMainDataSource] = useState<TReceiptsDetailEntry[]>([]);
    ...
    <div>
      <div className="Detail-wrape">
        <div className="Table">
          ...
          {voucherDetailData?.map((item: TReceiptsDetailEntry, index: number) => (
