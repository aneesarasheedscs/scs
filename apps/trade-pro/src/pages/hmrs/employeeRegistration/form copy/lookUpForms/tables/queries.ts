...
import { TGLAccounts } from '../../../Form/queryOptions';
...
export const useAddItemCategory = () => {
  return useMutation(
    'Item-Category',
    (data: TAddItemCategory | TGLAccounts) => {
      let dataToSubmit = {};
...
export const useUpdateItemCategory = (Id?: number, params?: TAddItemCategory | TGLAccounts) => {
  console.log(Id);

  return useMutation(
    'Item-Category',
    (data: TGLAccounts | TAddItemCategoryonUpdate) => {
      let dataToSubmit = {};
      const userDetail = storedUserDetail();
      dataToSubmit = {
        ...data,
