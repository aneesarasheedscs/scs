...
const ExperienceForm = ({ form }: TDynamicForm) => {
          ...
          <Col xl={12} xs={24}>
            <Row gutter={[10, 10]} justify={'space-between'}>
              <Col xxl={12} xl={12} sm={12} md={12} xs={24} className="formfield">
                <AntInput bordered={false} label={t('organization')} name="addressDetail" />
              </Col>
              ...
              <Col xl={12} lg={12} md={12} sm={12} xs={24} className="formfield">
                <AntDatePicker label="From Date" name="" bordered={false} />
              </Col>
              <Col xl={11} lg={11} md={11} sm={11} xs={24} className="formfield">
                <AntDatePicker label="To Date" name="" bordered={false} />
              </Col>
            </Row>
          </Col>
          <Col xl={11} xs={24}>
