...
import EmployeeGroupHistory from './tables/EmployeeGroupHistory';
...
function EmployeeGroup() {
  ...
  return (
    <AddButtonforItems open={open} handleOpen={handleOpen} handleClose={handleClose}>
      ...
      <h2 style={{ marginBottom: 20 }}> {t('employee_group')}</h2>
      <Card>
        <Form layout="inline" initialValues={{ remember: true }}>
          <Row gutter={[10, 10]} justify={'space-between'} style={{ width: '100%' }}>
            ...
            <Col
              ...
              className="formfield"
            >
              <AntInput name="CategoryCode" label={t('employee_group')} bordered={false} />
            </Col>
          </Row>
