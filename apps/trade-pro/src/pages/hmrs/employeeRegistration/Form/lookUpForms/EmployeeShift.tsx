...
import EmployeeShiftHistory from './tables/EmployeeShiftHistory';
...
function EmployeeShift() {
  ...
  return (
    <AddButtonforItems open={open} handleOpen={handleOpen} handleClose={handleClose}>
      ...
      <h2 style={{ marginBottom: 20 }}> {t('employee_shift')}</h2>
      <Card>
        <Form layout="inline" initialValues={{ remember: true }}>
          <Row gutter={[10, 10]} justify={'space-between'} style={{ width: '100%' }}>
            <Col
              ...
              className="formfield"
            >
              <AntInput name="CategoryCode" label={t('shift_name')} bordered={false} />
            </Col>
            <Col
              xxl={{ span: 12, offset: 1 }}
              xl={{ span: 12, offset: 1 }}
