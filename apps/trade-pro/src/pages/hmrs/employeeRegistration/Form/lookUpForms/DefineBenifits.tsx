...
import { AddButtonforBenefits } from '../AddButtonforItems';
import EmployeeCategory from './EmployeeCategory';
import DefineBenefitsHistory from './tables/BenifitsHistory';
...
function DefineBenefits() {
  ...
  return (
    <AddButtonforBenefits open={open} handleOpen={handleOpen} handleClose={handleClose}>
      <h4> {t('employee_information')} </h4>
      <Divider></Divider>

      <h2 style={{ marginBottom: 20 }}> {t('define_benefits')} </h2>
      <Card>
        <Form layout="inline" initialValues={{ remember: true }}>
          <Row gutter={[10, 10]} justify={'space-between'} style={{ width: '100%' }}>
            ...
            <Col
              ...
              className="formfield"
            >
              <AntInput name="CategoryCode" label={t('benefit_name')} bordered={false} />
            </Col>
            <Col
              ...
              className="formfield"
            >
              <AntInput name="CategoryDescription" label={t('prefix')} bordered={false} />
            </Col>
          </Row>
      ...
      <DefineBenefitsHistory />
    </AddButtonforBenefits>
  );
}
