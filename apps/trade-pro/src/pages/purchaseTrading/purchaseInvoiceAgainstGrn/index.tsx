...
import PurchaseInvoiceAgainstGRNForm from './form';
...
function PurchaseInvoiceAgainstGrn() {
  ...
  return (
    <>
      <h2 className="form-heading"> Purchase Invoice Against GRN </h2>
...
export default PurchaseInvoiceAgainstGrn;
