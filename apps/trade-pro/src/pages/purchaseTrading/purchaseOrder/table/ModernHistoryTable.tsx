...
const Tablefile: React.FC<{ selectedRecordId?: number | any; purchaseOrderHistory: any }> = ({
  selectedRecordId,
  ...
  const [mainDataSourc, setMainDataSourc] = useState<TPurchaseOrderDetailEntry[]>([]);
      ...
      <div>
        <div className="Detail-wrape">
          <div className="Table">
            ...
            {mainDataSourc?.map((item: TPurchaseOrderDetailEntry | any, index: number) => (
        ...
        <Row>
          ...
          >
            ...
            <div>
              ...
              <p>{formateDate(purchaseOrderHistory?.[0]?.ModifyDate)}</p>
            </div>
          </Col>
          <Col
            xs={{ span: 24 }}
