...
import DynamicForm from './BalanceEntry';
// import FormTable from '../Table/OpeningBalanceDetail';
import '.././Table/style.scss';
// import AccountOpeningBalanceDetail from '../Table';
// import AccountOpeningBalanceDetail from '../Table/Table';
const { useForm } = Form;
  ...
  return (
    <Card>
      ...
      >
        ...
        <Row gutter={[32, 32]}>
          <Col xs={24} sm={24} md={24} lg={24} xl={{ span: 10, offset: 7 }}>
