...
function StockTransferNotesDetail({ stockTransferDetail, isDataLoadingDetail, refetchDetail }: any) {
      ...
      <Row style={{ marginTop: '0.1%' }}>
        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 24 }} lg={{ span: 24 }} xl={{ span: 24 }} xxl={24}>
          ...
          <AntTable
            ...
            data={stockTransferDetail?.data?.Data?.Result?.WsRmStockTransferNotesDetailsList || []}
...
export default StockTransferNotesDetail;
