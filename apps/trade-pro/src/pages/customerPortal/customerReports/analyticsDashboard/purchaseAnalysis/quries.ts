...
import { TpuchaseAnalyticsCriteria, TpuchaseAnalyticsItemGroupCriteria } from './types';
...
export const useGetPurchaseAnalyticsReport = (
  enabled = true,
  params?: TpuchaseAnalyticsCriteria,
  StartDate?: Date,
  EndDate?: Date
) => {
  ...
  return useQuery(
    ...
    () => {
      return requestManager.post('api/InvPurchaseInvoice/PurchaseAnalyticsA_Report', {
...
export const useGetPurchaseInvoiceReport = (
  enabled = true,
  params?: TpuchaseAnalyticsCriteria,
  StartDate?: Date,
  EndDate?: Date,
...
SortNo?: number | null
  ...
  console.log(StartDate, 'startdate');
  return useQuery(
   [ 'purchase-invoice-party-wise', IpcIds,
   SortNo],
