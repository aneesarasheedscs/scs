...
function BookingDemand({ bookingDemandData }: Props) {
  ...
  return (
    <>
      <Row>
        <Col>
          {/* <ModalCriteria /> */}
          {/* <Col span={24}>{selectedItem.Activity === 'OutstandingBookingOrders' ? <BookingOrderSatus /> : ''}</Col> */}
          ...
          <Tabs type="card" size="large" className="tabs-margin-bottom-0">
            <Tabs.TabPane key="1" tab={t('item')}>
              <ItemTable data={bookingDemandData?.Table1} />
            </Tabs.TabPane>
            <Tabs.TabPane key="2" tab={t('customer')}>
              <CustomerTable data={bookingDemandData?.Table2} />
            </Tabs.TabPane>
            <Tabs.TabPane key="3" tab={t('item_pack')}>
              <ItemAndPackTable data={bookingDemandData?.Table3} />
            </Tabs.TabPane>
            <Tabs.TabPane key="4" tab={t('pack_item')}>
              <PackAndItemTable data={bookingDemandData?.Table3} />
            </Tabs.TabPane>
            <Tabs.TabPane key="5" tab={t('item_customer')}>
              <ItemAndCustomerTable data={bookingDemandData?.Table4} />
            </Tabs.TabPane>
            <Tabs.TabPane key="6" tab={t('customer_item')}>
              <CustomerAndItemTable data={bookingDemandData?.Table4} />
            </Tabs.TabPane>
          </Tabs>
        </Col>
      </Row>
