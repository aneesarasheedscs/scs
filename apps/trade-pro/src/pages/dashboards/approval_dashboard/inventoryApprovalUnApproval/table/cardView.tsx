...
const CardView: React.FC<{ setActiveTab: (tab: string) => void; setSelectedRecordId: (id: number | null) => void }> = ({
  ...
  const [records, setRecords] = useState<TRequisitionOrderforApprovalHistory[]>([]);
  const [selectedCardData, setSelectedCardData] = useState<TRequisitionOrderforApprovalHistory>();
  ...
  const handleSearch = (value: any) => {
    ...
    const filteredRecords = stockTransfer?.filter((record: TRequisitionOrderforApprovalHistory) => {
      ...
      <Row className="row1" style={{ border: '', width: '', height: '100%' }}>
        <Col lg={{ span: 8 }} xl={6} xxl={6} sm={{ span: 24 }} className="columns">
          ...
          <div style={{ backgroundColor: ' #d6d6e7', height: '52vh', overflowY: 'auto' }}>
            ...
            >
              {records?.map((card: TRequisitionOrderforApprovalHistory | any) => (
                    ...
                    <Col xxl={9} xl={12} lg={12} md={13} sm={14} style={{ marginTop: '0.5%' }}>
                      <div className="">
                        ...
                        <div className="caption-value-wrape">
                          ...
                          <div className="value">{totalqty > 0 ? numberFormatter(totalqty) : 0}</div>
                        </div>
                    ...
                    <Col xxl={9} xl={9} lg={9} md={9} sm={10} style={{ marginTop: '0.5%' }}>
                      <div className="">
                        ...
                        >
                          ...
                          <div className="value">{totalamount > 0 ? numberFormatter(totalamount) : 0}</div>
                        </div>
                      </div>
                      <div className="caption-value-wrape">
