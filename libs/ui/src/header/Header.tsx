...
import './Style.css';
import { getSidebarList } from './constant';
...
export function AppHeader({ appLogo, sideMenu, languageSwitcher }: TAppHeader) {
  ...
  const headerList = getSidebarList();
  return (
    <>
        ...
        <Row justify="space-between">
          ...
          <Col xl={12} style={{ display: 'flex', justifyContent: 'space-between' }}>
            <Row gutter={[10, 10]} style={{ width: '100%' }}>
              ...
              <Col>{/* <AntButton size="large" label="Logout" onClick={handleLogout} /> */}</Col>
            </Row>
          </Col>
          <Col>
            <Row gutter={40}>
      ...
      <SideDrawer open={open} handleClose={handleClose}></SideDrawer>
    </>
  );
}
